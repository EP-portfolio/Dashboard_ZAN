...
def get_data_last_update() -> str:
    ...
    data_file = base_path / "conso2009-2024-resultats-com.csv"
...
def get_data_source_html() -> str:
    """
    Retourne le HTML de source des données pour les graphiques
    
    Returns:
        HTML formaté avec source et date
    """
    last_update = get_data_last_update()
    return (
        f'<span style="font-size: 10px; color: #718096; font-style: italic;">'
        f'Source: {DATA_SOURCE} | Période: {DATA_PERIOD} | Mise à jour: {last_update}'
        f'</span>'
    )
